  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ActividadArrastrarSoLtarL')}>
          <ImageBackground source={require('../../../assets/img/arrastrar.jpeg')} style={styles.imageBackground} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('JuegoMemoriaL')}>
          <ImageBackground source={require('../../../assets/img/memoria.jpeg')} style={styles.imageBackground} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ClasificacionPalabrasL')}>
...
export default LenguajeActividades;