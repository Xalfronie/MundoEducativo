  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ActividadArrastrarSoLtarS')}>
          <ImageBackground source={require('../../../assets/img/arrastrar.jpeg')} style={styles.imageBackground} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('JuegoMemoriaS')}>
          <ImageBackground source={require('../../../assets/img/memoria.jpeg')} style={styles.imageBackground} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ClasificacionPalabrasS')}>
...
export default SocialesActividades;