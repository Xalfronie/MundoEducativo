...
const imagesData = [
  { id: 1, name: 'manzana_roja', source: require('./img/avion.jpg'), correctContainer: 'rojo' },
  { id: 2, name: 'uva_morada', source: require('./img/iglesia.jpg'), correctContainer: 'morado' },
  { id: 3, name: 'platano_amarillo', source: require('./img/elefante.jpg'), correctContainer: 'amarillo' },
];
...
const DragAndDropActivity = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Arrastra las imagenes a su cuadro con la letra inicial correspondiente</Text>
      ...
      <View style={styles.dropZoneContainer}>
        <View style={[styles.dropZone, { backgroundColor: 'red' }]}>
          <Text style={styles.dropZoneText}>A</Text>
          {placedImages.includes('manzana_roja') && (
            <Image source={require('./img/avion.jpg')} style={styles.placedImage} />
          )}
        </View>
        <View style={[styles.dropZone, { backgroundColor: 'green' }]}>
          <Text style={styles.dropZoneText}>I</Text>
          {placedImages.includes('uva_morada') && (
            <Image source={require('./img/iglesia.jpg')} style={styles.placedImage} />
          )}
        </View>
        <View style={[styles.dropZone, { backgroundColor: 'blue' }]}>
          <Text style={styles.dropZoneText}>E</Text>
          {placedImages.includes('platano_amarillo') && (
            <Image source={require('./img/elefante.jpg')} style={styles.placedImage} />
          )}
        </View>
      </View>
