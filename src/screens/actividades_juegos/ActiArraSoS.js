...
const imagesData = [
  { id: 1, name: 'manzana_roja', source: require('./img/policia.png'), correctContainer: 'rojo' },
  { id: 2, name: 'uva_morada', source: require('./img/bombero.png'), correctContainer: 'morado' },
  { id: 3, name: 'platano_amarillo', source: require('./img/doctor.png'), correctContainer: 'amarillo' },
];
...
const DragAndDropActivity = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Arrastra las imagenes a su cuadro correspondiente</Text>
      ...
      <View style={styles.dropZoneContainer}>
        <View style={[styles.dropZone, { backgroundColor: 'red' }]}>
          <Text style={styles.dropZoneText}>POLICIA</Text>
          {placedImages.includes('manzana_roja') && (
            <Image source={require('./img/policia.png')} style={styles.placedImage} />
          )}
        </View>
        <View style={[styles.dropZone, { backgroundColor: 'green' }]}>
          <Text style={styles.dropZoneText}>BOMBERO</Text>
          {placedImages.includes('uva_morada') && (
            <Image source={require('./img/bombero.png')} style={styles.placedImage} />
          )}
        </View>
        <View style={[styles.dropZone, { backgroundColor: 'blue' }]}>
          <Text style={styles.dropZoneText}>DOCTOR</Text>
          {placedImages.includes('platano_amarillo') && (
            <Image source={require('./img/doctor.png')} style={styles.placedImage} />
          )}
        </View>
      </View>
